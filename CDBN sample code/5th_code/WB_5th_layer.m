function [acc, weight, params] = WB_5th_layer...
...
if strcmp(params.txtype, 'rot'),
    fname = sprintf('WB_5th(rbm)_10_(2f40f288f1000f6ws9ws9ws36wsP10Pb0401)_%s_w%d_b%02d_%s_nrot%d_pb%g_pl%g', ...
...
elseif strcmp(params.txtype, 'trans') || strcmp(params.txtype, 'scale'),
    fname = sprintf('WB_5th(rbm)_10_(2f40f288f1000f6ws9ws9ws36wsP10Pb0401)_%s_w%d_b%02d_%s_ntx%d_gr%d_pb%g_pl%g', ...
