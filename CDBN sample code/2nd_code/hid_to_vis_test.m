...
One=load('sandstone_alloy_w6_b24_rot_nrot1_pb0.3_pl10_iter_4000.mat');
addpath('utils','function_code')
addpath('2nd_hidstate')
fname=sprintf('sandstone_2nd_w9_b40_trans_ntx1_gr1_pb0.1_pl20_iter_2000');
...
for ii = 1:100
    ...
    fname=sprintf('hidstate_2nd_sandstone_(2f40f6ws9ws)_%d',ii); %WB
