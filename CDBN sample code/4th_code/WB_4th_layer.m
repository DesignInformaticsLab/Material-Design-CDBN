...
npatch = 10; %%% test,original 12000
[xtrain, patches] = load_patches_4th_layer(npatch, params.rs);
...
if strcmp(params.txtype, 'rot'),
    fname = sprintf('WB_4th(rbm)_10_(2f40f288f1000f6ws9ws9ws36ws)_%s_w%d_b%02d_%s_nrot%d_pb%g_pl%g', ...
...
elseif strcmp(params.txtype, 'trans') || strcmp(params.txtype, 'scale'),
    fname = sprintf('WB_4th(rbm)_10_(2f40f288f1000f6ws9ws9ws36ws)_%s_w%d_b%02d_%s_ntx%d_gr%d_pb%g_pl%g', ...
...
%     [weight, params] = training_2nd_layer(patches', params, Tlist);
    [weight, params] = training_4th_layer(patches', params);
end
clear patches;
